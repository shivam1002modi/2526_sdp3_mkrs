...
TEST_CASES = [
    ...
    # ── DOCKER KNOWLEDGE (10 questions) ──────────────────────────────────
    {"id": "Q21", "query": "What is the difference between the docker run and docker start commands?",
     "source_pdf": "Docker", "keywords": [["image", "input"], ["container", "starts"], "new"],
     "trap_word": None, "is_stress": False},
    {"id": "Q22", "query": "What does the -a flag do when used with the docker ps command?",
     "source_pdf": "Docker", "keywords": ["all", "containers", ["stopped", "running"]],
     "trap_word": None, "is_stress": False},
    {"id": "Q23", "query": "What is a Dockerfile and what is its primary purpose?",
     "source_pdf": "Docker", "keywords": [["text-based", "document"], "image", "instructions"],
     "trap_word": None, "is_stress": False},
    {"id": "Q24", "query": "How can you give a specific name to a container when running it from an image?",
     "source_pdf": "Docker", "keywords": ["--name", ["container_name", "image_name"]],
     "trap_word": None, "is_stress": False},
    {"id": "Q25", "query": "What are the four main steps mentioned to work with a Dockerfile?",
     "source_pdf": "Docker", "keywords": ["Create", "Build", "Run", ["Add instructions", "instructions"]],
     "trap_word": None, "is_stress": False},
    {"id": "Q26", "query": "Why are Docker volumes necessary for stateful applications like databases?",
     "source_pdf": "Docker", "keywords": ["persistent", "storage", ["independent", "failure"], "persists"],
     "trap_word": None, "is_stress": False},
    {"id": "Q27", "query": "Where are Docker volumes usually stored on a Linux host system?",
     "source_pdf": "Docker", "keywords": ["/var/lib/docker/volumes"],
     "trap_word": None, "is_stress": False},
    {"id": "Q28", "query": "What is the difference between Bind Mounts and Docker Volumes?",
     "source_pdf": "Docker", "keywords": [["managed by Docker", "docker managed"], "host", "directories"],
     "trap_word": None, "is_stress": False},
    {"id": "Q29", "query": "What is Docker Compose and why is it useful for multi-container applications?",
     "source_pdf": "Docker", "keywords": ["multi-container", "YAML", "single", ["productivity", "isolated"]],
     "trap_word": None, "is_stress": False},
