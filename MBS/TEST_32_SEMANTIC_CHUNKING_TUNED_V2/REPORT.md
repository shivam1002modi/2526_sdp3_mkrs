# TEST 32 — SEMANTIC_CHUNKING_TUNED_V2
## MKRS Brain Snapshot

> **Date**: 2026-02-26 00:57:11
> **MBS Version**: 1.0
> **TMS Score**: **77.71 / 100**
...
| LAT – Speed | avg 3.22s | 0.6208 | ×10 | **6.21** |
...
| :-- | :--- | :---: | :---: | :---: | ---: | :--- |
| Q01 | [MAIN] What is a black hole? | ✅ | 0.67 |  | 4.9s | ⚠️ Partial |
| Q02 | [MAIN] Who coined the term black hole and when? | ✅ | 0.00 |  | 2.9s | ❌ Failed SEC |
| Q03 | [MAIN] What is the Event Horizon of a black hole? | ✅ | 1.00 |  | 3.4s | ✅ Pass |
...
| Q09 | [MAIN] What is Navratri festival? | ✅ | 1.00 |  | 4.2s | ✅ Pass |
| Q10 | [MAIN] Who is Mahishasura in the Navratri legend? | ✅ | 1.00 |  | 3.0s | ✅ Pass |
| Q11 | [MAIN] What is RAG's role in the SIH 2025 chatbot? | ✅ | 0.67 |  | 4.4s | ⚠️ Partial |
| Q12 | [MAIN] What caused dinosaur extinction 66 million years a | ✅ | 0.00 |  | 2.8s | ❌ Failed SEC |
| Q13 | [MAIN] What is Robert Sternberg's Triangular Theory of Lo | ✅ | 1.00 |  | 2.9s | ✅ Pass |
| Q14 | [STRESS] What is the Mars Mission about? | ✅ | 1.00 |  ✅ | 3.6s | ✅ Pass |
| Q15 | [STRESS] What type of fuel does the Mars rocket use? | ✅ | 0.00 |  ✅ | 3.0s | ❌ Failed SEC |
| Q16 | [STRESS] What is the landing zone for the Mars mission? | ✅ | 1.00 |  ✅ | 3.1s | ✅ Pass |
...
| Q19 | [STRESS] Which department had the highest profit in Q3 2025 | ✅ | 0.00 |  ✅ | 3.2s | ❌ Failed SEC |
...
| Retrieval k (candidates) | 20 (top-3 after re-ranking) |
| Device | CPU |
...
[Rasa Actions :5055] → ActionQueryDoc.run()
    ...
    ├─ ChromaDB.similarity_search(k=20) → top-20 chunks
...
*Archived 2026-02-26 00:57:11 — MBS v1.0*
