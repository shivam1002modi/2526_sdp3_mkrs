# TEST 67 — Optimized Tiered Re-Ranking Run
## MKRS Brain Snapshot

> **Date**: 2026-03-13 10:18:12
> **MBS Version**: 1.0
> **TMS Score**: **90.66 / 100**
...
| LAT – Speed | avg 5.01s | 0.3992 | ×10 | **3.99** |
...
| Q05 | [MAIN] What is Sagittarius A star? | ✅ | 1.00 |  | 5.0s | ✅ Pass |
| Q06 | [MAIN] What is the historical significance of Delhi? | ✅ | 1.00 |  | 7.0s | ✅ Pass |
| Q07 | [MAIN] Who built the Red Fort and what city did they foun | ✅ | 1.00 |  | 4.5s | ✅ Pass |
| Q08 | [MAIN] When did the British shift India's capital to Delh | ✅ | 1.00 |  | 4.1s | ✅ Pass |
...
| Q12 | [MAIN] What caused dinosaur extinction 66 million years a | ✅ | 0.67 |  | 4.4s | ⚠️ Partial |
...
| Q17 | [STRESS] How long do you bake Apple Pie? | ✅ | 0.50 |  ✅ | 4.0s | ⚠️ Partial |
| Q18 | [STRESS] What temperature to preheat oven for Apple Pie? | ✅ | 1.00 |  ✅ | 3.9s | ✅ Pass |
| Q19 | [STRESS] Which department had the highest profit in Q3 2025 | ✅ | 1.00 |  ✅ | 4.2s | ✅ Pass |
| Q20 | [STRESS] Which department has the lowest margin in the Q3 2 | ✅ | 0.50 |  ✅ | 10.6s | ⚠️ Partial |
| Q21 | [MAIN] What is the difference between the docker run and  | ✅ | 1.00 |  | 4.4s | ✅ Pass |
| Q22 | [MAIN] What does the -a flag do when used with the docker | ✅ | 1.00 |  | 4.2s | ✅ Pass |
| Q23 | [MAIN] What is a Dockerfile and what is its primary purpo | ✅ | 1.00 |  | 4.8s | ✅ Pass |
| Q24 | [MAIN] How can you give a specific name to a container wh | ✅ | 1.00 |  | 4.2s | ✅ Pass |
| Q25 | [MAIN] What are the four main steps mentioned to work wit | ✅ | 1.00 |  | 4.3s | ✅ Pass |
...
| Q28 | [MAIN] What is the difference between Bind Mounts and Doc | ✅ | 0.67 |  | 4.5s | ⚠️ Partial |
| Q29 | [MAIN] What is Docker Compose and why is it useful for mu | ✅ | 0.50 |  | 5.7s | ⚠️ Partial |
...
*Archived 2026-03-13 10:18:12 — MBS v1.0*
