# TEST 23 — PHASE_2A_FINAL
## MKRS Brain Snapshot

> **Date**: 2026-02-22 13:05:40
> **MBS Version**: 1.0
> **TMS Score**: **74.17 / 100**
...
| SEC – Fact Accuracy | 36.7% | 0.3667 | ×30 | **11.00** |
| NEG – No Hallucination | 95.0% | 0.9500 | ×10 | **9.50** |
| LAT – Speed | avg 3.53s | 0.5669 | ×10 | **5.67** |
...
| :-- | :--- | :---: | :---: | :---: | ---: | :--- |
| Q01 | [MAIN] What is a black hole? | ✅ | 1.00 |  | 7.8s | ✅ Pass |
| Q02 | [MAIN] Who coined the term black hole and when? | ✅ | 0.00 |  | 5.6s | ❌ Failed SEC |
| Q03 | [MAIN] What is the Event Horizon of a black hole? | ✅ | 1.00 |  | 4.2s | ✅ Pass |
| Q04 | [MAIN] What is Hawking Radiation? | ✅ | 0.00 |  | 2.8s | ❌ Failed SEC |
| Q05 | [MAIN] What is Sagittarius A star? | ❌ | 0.00 |  | 0.4s | ❌ Not retrieved |
| Q06 | [MAIN] What is the historical significance of Delhi? | ✅ | 0.33 |  | 5.4s | ⚠️ Partial |
| Q07 | [MAIN] Who built the Red Fort and what city did they foun | ✅ | 0.67 |  | 3.2s | ⚠️ Partial |
| Q08 | [MAIN] When did the British shift India's capital to Delh | ✅ | 0.00 |  | 2.8s | ❌ Failed SEC |
| Q09 | [MAIN] What is Navratri festival? | ✅ | 0.67 |  | 4.9s | ⚠️ Partial |
| Q10 | [MAIN] Who is Mahishasura in the Navratri legend? | ✅ | 1.00 |  | 3.2s | ✅ Pass |
| Q11 | [MAIN] What is RAG's role in the SIH 2025 chatbot? | ✅ | 0.67 |  | 3.2s | ⚠️ Partial |
| Q12 | [MAIN] What caused dinosaur extinction 66 million years a | ✅ | 0.00 |  | 2.9s | ❌ Failed SEC |
| Q13 | [MAIN] What is Robert Sternberg's Triangular Theory of Lo | ✅ | 1.00 |  | 3.5s | ✅ Pass |
| Q14 | [STRESS] What is the Mars Mission about? | ✅ | 1.00 |  ❌HALL | 3.4s | ✅ Pass |
| Q15 | [STRESS] What type of fuel does the Mars rocket use? | ✅ | 0.00 |  ✅ | 2.9s | ❌ Failed SEC |
| Q16 | [STRESS] What is the landing zone for the Mars mission? | ✅ | 0.00 |  ✅ | 2.9s | ❌ Failed SEC |
| Q17 | [STRESS] How long do you bake Apple Pie? | ✅ | 0.00 |  ✅ | 2.9s | ❌ Failed SEC |
| Q18 | [STRESS] What temperature to preheat oven for Apple Pie? | ✅ | 0.00 |  ✅ | 2.8s | ❌ Failed SEC |
| Q19 | [STRESS] Which department had the highest profit in Q3 2025 | ✅ | 0.00 |  ✅ | 3.0s | ❌ Failed SEC |
| Q20 | [STRESS] Which department has the lowest margin in the Q3 2 | ✅ | 0.00 |  ✅ | 2.8s | ❌ Failed SEC |
...
| Retrieval k (candidates) | 12 (top-3 after re-ranking) |
| Device | CPU |
...
[Rasa Actions :5055] → ActionQueryDoc.run()
    ...
    ├─ ChromaDB.similarity_search(k=12) → top-12 chunks
...
*Archived 2026-02-22 13:05:40 — MBS v1.0*
